...
const PracticeReact = (props) => {

    const [ selectedFile, setSelectedFile ] = useState();
    const [ showImages, setShowImages ] = useState();


    storage.child('Esel.png').getDownloadURL().then((url) => {
        setShowImages(url);
        //let img = document.getElementById('myImg');
        //img.src = url;
        console.log('Image download: ',showImages );
    }).catch((error) => {
        // Handle any errors
        console.log(' Error by download image ', error);
    });
    ...
    return (
        ...
        <React.Fragment>
            <div className="Dashboard">
                ...
                <div>
                    <p>Esel image</p>
                    <img className='Dashboard_Img' src={showImages} alt="Esel Bild" />
                </div>
                <div>
                    {msg}
                    <br/>
